...
/**
 * Very early initial implementation of the Threefish encryption algorithm. For
 * performance reasons, this class is definately <strong>not thead
 * safe</strong>.
 *
 * @author maartenb
 * @author $Author: $
...
public class ThreefishImpl {
	...
	/**
	 * Threefish implementation using the specified blocksize in bits,
	 * specifying the number of rounds directly instead of using the default
	 * number of rounds depending on the blockSize. Mainly used for
	...
	/**
	 * Implementation of the E(K, T, P) function. The K and T values should
	 * be set previously using the init() method. This version is the 64 bit
	...
	/**
	 * Implementation of the D(K, T, C) function. The K and T values should
	 * be set previously using the init() method. This version is the 64 bit
	 * implementation of Threefish.
	 *
	...
	/**
	 * Simply returns the block size in bits as set by the constructor. The
	 * block size cannot be altered after the instance has been constructed.
	 *
