 ...
 * Skein 1.3 512-512.
 *
 * @author	Thomas Mueller, 2008-2010. Public domain.
 */
public class Skein512Small {

	public static void hash(byte[] m, byte[] h) throws IOException {
		...
		System.err.println(
			"Skein512Small.class:\n"
			+ org.apache.commons.codec.binary.Hex.encodeHexString(h).replaceAll("[0]+$", "").replaceAll("[a]", "A").replaceAll("[e]", "E")
			+ "\n"
		);
	}
